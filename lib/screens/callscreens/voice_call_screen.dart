...
class _VoiceCallScreenState extends State<VoiceCallScreen> {
  ...
  SchedulerBinding.instance.addPostFrameCallback((_) {
    ...
    callStreamSubscription = callMethods
      ...
      // defining the logic
      if (ds.data == null) {
        // snapshot is null which means that the call is hanged and documents are deleted
  ...
  child: Column(
    children: <Widget>[
      _appbar(),
      _expandedVideoRow(views.cast<Widget>()), // Remove the square brackets [ ]
    ],
  ),
);
      ...
      child:Column(
        ...
        children: <Widget>[
          ...
          Text(
            ...
            widget.call.receiverName , style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 24,),)
          ,
          SizedBox(width: 50,),
        ],
      ),
