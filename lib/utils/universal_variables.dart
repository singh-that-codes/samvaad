...
class UniversalVariables {
  ...
  static final Color bgColor = Color(0xFF0087BB);
  static final Color white = Color(0xffffffff);
  static final Color newgradientColorStart = Color(0xFF1EAE98);
  static final Color newgradientColorEnd = Color(0xFF11998E);
  ...
  static final Gradient fabGradient = LinearGradient(
      colors: [newgradientColorStart, newgradientColorEnd],
